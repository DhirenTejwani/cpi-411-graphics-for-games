...
namespace Assignment2
{
    ...
    public class Assignment2 : Game
    {
        ...
        int skyboxID = 0;
        int modelID = 0;
        Model modelBunny, modelTorus, modelCube, modelSphere, modelTeapot, modelHeli;
        ...
        protected override void LoadContent()
        {
            ...
            modelBunny = Content.Load<Model>("bunny");
            modelTorus = Content.Load<Model>("Torus");
            modelCube = Content.Load<Model>("Box");
            modelTeapot = Content.Load<Model>("Teapot");
            modelSphere = Content.Load<Model>("Sphere");
            modelHeli = Content.Load<Model>("Helicopter");
            //skyboxTextures=
            //    {
            //    "skybox/SunsetPNG1", "skybox/SunsetPNG2",
            //        "skybox/SunsetPNG3", "skybox/SunsetPNG4",
            //        "skybox/SunsetPNG5", "skybox/SunsetPNG6",
            //    };
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.D1)){ model = modelCube; texon = false; }
            if (Keyboard.GetState().IsKeyDown(Keys.D2)){ model = modelSphere; texon = false; }
            if (Keyboard.GetState().IsKeyDown(Keys.D3)){ model = modelTorus; texon = false; }
            if (Keyboard.GetState().IsKeyDown(Keys.D4)){ model = modelTeapot; texon = false; }
            if (Keyboard.GetState().IsKeyDown(Keys.D5)){ model = modelBunny; texon = false; }
            if (Keyboard.GetState().IsKeyDown(Keys.D6)) { model = modelHeli; texon = true; }
